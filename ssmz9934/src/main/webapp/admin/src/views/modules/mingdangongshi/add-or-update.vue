    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资助金额" prop="zizhujine">
          <el-input v-model="ruleForm.zizhujine" 
              placeholder="资助金额" clearable  :readonly="ro.zizhujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资助金额" prop="zizhujine">
              <el-input v-model="ruleForm.zizhujine" 
                placeholder="资助金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资助年限" prop="zizhunianxian">
          <el-input v-model="ruleForm.zizhunianxian" 
              placeholder="资助年限" clearable  :readonly="ro.zizhunianxian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资助年限" prop="zizhunianxian">
              <el-input v-model="ruleForm.zizhunianxian" 
                placeholder="资助年限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	gongshitupian : false,
      ...
      rules: {
          ...
          zizhujine: [
                { required: true, message: '资助金额不能为空', trigger: 'blur' },
          ],
          xueshengxingming: [
          ],
          zizhunianxian: [
                { required: true, message: '资助年限不能为空', trigger: 'blur' },
          ],
          gongshibiaoti: [
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `mingdangongshi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.mingdangongshiCrossAddOrUpdateFlag = false;
						 this.parent.search();
