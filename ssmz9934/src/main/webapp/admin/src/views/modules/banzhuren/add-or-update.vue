<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作证" prop="gongzuozheng">
          <el-input v-model="ruleForm.gongzuozheng" 
              placeholder="工作证" clearable  :readonly="ro.gongzuozheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作证" prop="gongzuozheng">
              <el-input v-model="ruleForm.gongzuozheng" 
                placeholder="工作证" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          gongzuozheng: [
                { required: true, message: '工作证不能为空', trigger: 'blur' },
          ],
          sfsh: [
          ],
          shhf: [
